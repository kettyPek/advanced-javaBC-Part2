...
public interface ProductDao {
	...
	public default List<Product> getProductsBySupplier(Integer supplierId) throws DaoException {
		throw new DaoException("Method not implemented");
	}
	...
	public default void deleteCategoryById(int categoryId) throws DaoException{
		throw new DaoException("Method not implemented");
	}
	
	public default void deleteSupplierById(int supplierId) throws DaoException{
		throw new DaoException("Method not implemented");
	}
